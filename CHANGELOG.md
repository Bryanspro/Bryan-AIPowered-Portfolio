...
## [v1.8] - 2026-05-22
### Added
- Added two new videos (YouTube Shorts `EbldhJpztkI` and `6L9LDmxw5PE`) to the **Neon Player**'s randomized startup pool, supporting dynamic scaling and choosing from the pool with equal probability on page load.
...
### Changed
- Rebranded the background player to **Neon Player** to support any format of video/audio playback.
